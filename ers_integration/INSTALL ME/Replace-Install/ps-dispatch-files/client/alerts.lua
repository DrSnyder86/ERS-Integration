...
local function CarJacking(vehicle)
    ...
    local dispatchData = {
        message = locale('Attempted Car Jacking'),
        codeName = 'carjack',
        code = '10-16',
        icon = 'fas fa-car',
        priority = 2,
...
local function OfficerDown()
    ...
    local dispatchData = {
        message = locale('ALL UNITS RESPOND'),
...
local function OfficerBackup()
    ...
    local dispatchData = {
        message = locale('Officer Needs Help'),
