...
RegisterNetEvent('ers:server:TogglePoliceShift', function()
    local src = source
    toggleShift(src, "police", "Police")
end)

-- ===========================================
-- AMBULANCE DUTY TOGGLE
-- ===========================================
RegisterNetEvent('ers:server:ToggleAmbulanceShift', function()
    local src = source
    toggleShift(src, "ambulance", "EMS")
end)
...
RegisterNetEvent('ers:server:ToggleFireShift', function()
    local src = source
    toggleShift(src, "fire", "Fire Department")
end)
...
RegisterNetEvent('ErsIntegration::OnAcceptedCalloutOffer', function(calloutData)
    ...
    CreateThread(function()
        ...
        TriggerEvent('ps-dispatch:server:notify', {
            ...
            alertTime = 10,
            information = ("%s-%s is responding to the latest 911 Call."):format(
                lastName, 
                callsign),
...
RegisterNetEvent('ErsIntegration::OnPullover', function(pedData, vehicleData)
    ...
    -- Radar Lock + Notification (Combined Setting)
    ...
    -- Dispatch Notification (Always Happens)
    CreateThread(function()
...
RegisterNetEvent('ErsIntegration::OnPulloverEnded', function(pedData, vehicleData)
    ...
    CreateThread(function()
        ...
        TriggerEvent('ps-dispatch:server:notify', {
            ...
            alertTime = 10,
            jobs = { 'leo', 'ems' },
            information = ("%s (%s). Code-4 from my last %s."):format(
                lastName, 
                callsign, 
                plate),
...
RegisterNetEvent('ErsIntegration::OnPursuitStarted', function(pedData, vehicleData)
    ...
    CreateThread(function()
        ...
        TriggerEvent('ps-dispatch:server:notify', {
            ...
            alertTime = 15,
            jobs = {  'leo', 'ems' },
            information = ("%s-%s Show me in a %s."):format(
                lastName, 
                callsign, 
                plate),
...
RegisterNetEvent('ErsIntegration:server:OnCoronerRequested', function(postal)
    ...
    CreateThread(function()
        ...
        TriggerEvent('ps-dispatch:server:notify', {
            ...
            priority = 1,
            jobs = { 'mechanic', 'tow', 'police', 'ems' },
            information = ("Dispatch to %s (%s). Be advised local Coroner is confirmed 10-97 to your location nearest Postal %s."):format(
                lastName, 
                callsign, 
                postal or 'Unknown'),          
        })
...
RegisterNetEvent('ErsIntegration:server:OnTowRequested', function(postal)
    ...
    CreateThread(function()
        ...
        TriggerEvent('ps-dispatch:server:notify', {
            ...
            alertTime = 10,
            jobs = { 'mechanic', 'tow', 'police', 'ems' },
            information = ("Dispatch to %s (%s). Be advised a Tow Truck Service is confirmed 10-97 to your location nearest Postal %s."):format(
                lastName, 
                callsign, 
                postal or 'Unknown'),
        })
...
RegisterNetEvent('ErsIntegration:server:OnTaxiRequested', function(postal)
    ...
    CreateThread(function()
        ...
        TriggerEvent('ps-dispatch:server:notify', {
            ...
            alertTime = 10,
            jobs = { 'mechanic', 'tow', 'police', 'ems' },
            information = ("Dispatch to %s (%s). Be advised a Taxi Service has been dispatched and is confirmed 10-97 to your location nearest Postal %s."):format(
                lastName, 
                callsign, 
                postal or 'Unknown'),
        })
...
RegisterNetEvent('ErsIntegration:server:OnPoliceRequested', function(postal)
    ...
    CreateThread(function()
        ...
        TriggerEvent('ps-dispatch:server:notify', {
            ...
            alertTime = 10,
            jobs = { 'mechanic', 'tow', 'police', 'ems' },
            information = ("Dispatch to %s (%s). Be advised a Police Transport has been dispatched and is confirmed 10-97 to your location nearest Postal %s."):format(
                lastName, 
                callsign, 
                postal or 'Unknown'),
        })
...
RegisterNetEvent('ErsIntegration:server:OnAnimalRescueRequested', function(postal)
    ...
    CreateThread(function()
        ...
        TriggerEvent('ps-dispatch:server:notify', {
            ...
            alertTime = 10,
            jobs = { 'mechanic', 'tow', 'police', 'ems' },
            information = ("Dispatch to %s (%s). Be advised a Animal Control Supervisor has been dispatched and is confirmed 10-97 to your location nearest Postal %s."):format(
                lastName, 
                callsign, 
                postal or 'Unknown'),
        })
...
RegisterNetEvent('ErsIntegration:server:OnAmbulanceRequested', function(postal)
    ...
    CreateThread(function()
        ...
        TriggerEvent('ps-dispatch:server:notify', {
            ...
            alertTime = 10,
            jobs = { 'mechanic', 'tow', 'police', 'ems' },
            information = ("Dispatch to %s (%s). Be advised a Paramedic has been dispatched and is confirmed 10-97 to your location nearest Postal %s."):format(
                lastName, 
                callsign, 
                postal or 'Unknown'),
        })
...
RegisterNetEvent('ErsIntegration:server:OnFireRequested', function(postal)
    ...
    CreateThread(function()
        ...
        TriggerEvent('ps-dispatch:server:notify', {
            ...
            alertTime = 10,
            jobs = { 'mechanic', 'tow', 'police', 'ems' },
            information = ("Dispatch to %s (%s). Be advised Fire Rescue has been dispatched and is confirmed 10-97 to your location nearest Postal %s."):format(
                lastName, 
                callsign, 
                postal or 'Unknown'),
        })
...
RegisterNetEvent('ErsIntegration:server:OnRoadServiceRequested', function(postal)
    ...
    CreateThread(function()
        ...
        TriggerEvent('ps-dispatch:server:notify', {
            ...
            alertTime = 10,
            jobs = { 'mechanic', 'tow', 'police', 'ems' },
            information = ("Dispatch to %s (%s). Be advised a Road Service Crew is confirmed 10-97 to your location nearest Postal %s."):format(
                lastName, 
                callsign, 
                postal or 'Unknown'),
        })
